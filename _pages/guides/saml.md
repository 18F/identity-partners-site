...
<div class="usa-alert usa-alert--warning">
  <div class="usa-alert__body">
    <p class="usa-alert__text">If you have the choice, we recommend <a href="{{ site.baseurl }}/guides/oidc/">OpenID Connect</a> over SAML due to its simplicity, API-centric design, and support for native mobile applications. Agencies typically have much fewer issues integrating.</p>
  </div>
</div>
